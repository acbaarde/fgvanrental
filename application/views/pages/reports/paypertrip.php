...
<div class="row" id="paypertripform">
    <div class="col-md-12">
...
<script>
    $(function(){
        var paypertripform = $('#paypertripform');
        // paypertripform.hide();
        const __paypertripform = {
            initialize: function(){
                const self = this;
                this.loadForm();
            },
            ...
            loadEvents: function(){
                ...
                $("#mperiod").on('change', function(){
                    ...
                    var win = window.open('<?php echo base_url();?>reports/paypertrip_rpt?myear='+myear+'&mcompany='+mcompany+'&mperiod='+mperiod, '_blank');
                    win.focus();
