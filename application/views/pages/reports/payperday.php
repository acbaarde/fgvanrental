...
<div class="row" id="payperdayform">
    <div class="col-md-12">
...
<script>
    $(function(){
        var payperdayform = $('#payperdayform');
        // payperdayform.hide();
        const __payperdayform = {
            initialize: function(){
                const self = this;
                this.loadForm();
            },
            ...
            loadEvents: function(){
                ...
                $("#mperiod").on('change', function(){
                    ...
                    var win = window.open('<?php echo base_url();?>reports/payperday_rpt?myear='+myear+'&mcompany='+mcompany+'&mperiod='+mperiod, '_blank');
                    win.focus();
