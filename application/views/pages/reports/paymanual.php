...
<div class="row" id="paymanualform">
    <div class="col-md-12">
...
<script>
    $(function(){
        var paymanualform = $('#paymanualform');
        const __paymanualform = {
            initialize: function(){
                const self = this;
                this.loadForm();
            },
            ...
            loadEvents: function(){
                ...
                $("#mperiod").on('change', function(){
                    ...
                    var win = window.open('<?php echo base_url();?>reports/paymanual_rpt?myear='+myear+'&mcompany='+mcompany+'&mperiod='+mperiod, '_blank');
                    win.focus();
