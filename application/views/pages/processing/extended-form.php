                ...
                $.each(obj['result'], function(i,v){
                    ...
                    extendedform.find('tbody').append($('<tr>').attr('id',this.id).attr('style','text-align:center;')
                                                ...
                                                .append($('<td>').addClass('day_1').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_1 > 0 ? this.day_1 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_2').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_2 > 0 ? this.day_2 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_3').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_3 > 0 ? this.day_3 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_4').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_4 > 0 ? this.day_4 : '').attr('text','text').attr('size',4).attr('maxlength',2))) 
                                                .append($('<td>').addClass('day_5').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_5 > 0 ? this.day_5 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_6').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_6 > 0 ? this.day_6 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_7').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_7 > 0 ? this.day_7 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_8').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_8 > 0 ? this.day_8 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_9').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_9 > 0 ? this.day_9 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_10').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_10 > 0 ? this.day_10 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_11').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_11 > 0 ? this.day_11 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_12').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_12 > 0 ? this.day_12 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_13').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_13 > 0 ? this.day_13 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_14').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_14 > 0 ? this.day_14 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_15').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_15 > 0 ? this.day_15 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
                                                .append($('<td>').addClass('day_16').attr('style','display: none;')
                                                    .append($('<input>').attr('value', this.day_16 > 0 ? this.day_16 : '').attr('text','text').attr('size',4).attr('maxlength',2)))
